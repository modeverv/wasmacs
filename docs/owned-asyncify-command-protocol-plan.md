...
- `node scripts/probe-browser-host-entrypoint.mjs`
- `node scripts/probe-browser-asyncify-minibuffer-suspend-state.mjs`
...
- `node scripts/probe-browser-persistent-callmain.mjs`
- `node scripts/probe-browser-host-entrypoint.mjs`
- `node scripts/probe-browser-worker-real-undo.mjs`
- `node scripts/probe-browser-worker-redo.mjs`
- `node scripts/probe-browser-worker-file-switch-undo.mjs`

Diagnostic probes:

- `node scripts/probe-browser-asyncify-interactive-start.mjs`
- `node scripts/probe-browser-asyncify-minibuffer-waitpoint.mjs`
- `node scripts/probe-browser-asyncify-minibuffer-suspend-state.mjs`
- `node scripts/probe-browser-minibuffer-active-read-boundary.mjs`
- `node scripts/probe-browser-file-buffer-gc-roots.mjs`
- `node scripts/probe-browser-visited-file-cross-eval.mjs`
- `node scripts/probe-browser-find-file-phases.mjs`
- `node scripts/probe-browser-undo-tail-phases.mjs`
...
`scripts/patch-emacs-host-entrypoint-spike.sh` injects
...
- `node scripts/probe-browser-asyncify-file-switch-undo-gc.mjs`
...
- `node scripts/run-browser-smoke.mjs asyncify`
...
- `node scripts/run-browser-smoke.mjs asyncify-boot`
...
`scripts/probe-emacs-pdump-configure.sh` proves pdumper can be enabled at
configure time for the copied Emscripten source tree. `scripts/probe-emacs-pdump-temacs-build.sh`
