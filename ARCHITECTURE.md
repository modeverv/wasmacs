...
Milestone 13.5 以降の substrate contract は `small-os-for-emacs.md` に置く。
...
低レイヤ substrate は C/wasm-first とする。`app/src/small-os-services.js`
と `app/src/small-os-runtime.js` は service contract の mirror、browser-side
