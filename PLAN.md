...
- `scripts/build-emacs-browser-interactive.sh` now builds a pdmp-free
...
- 2026-06-03: `small-os-for-emacs.md` now defines `Terminal/Tty Service`,
...
- Added `scripts/probe-browser-asyncify-outer-resume.mjs` with minimal C
...
- [x] `npm test` passes
- [x] docs/os-compatibility-boundary.md updated
...
- `scripts/probe-browser-xterm-boot-loadup-smoke.mjs` — boot loadup smoke PASS
...
- docs/os-compatibility-boundary.md: cold loadup blocker documented as open
