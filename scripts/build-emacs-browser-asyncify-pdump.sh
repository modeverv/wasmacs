...
out_dir="${repo_root}/artifacts/emacs-browser-asyncify-pdump"
...
base_exports="_main,_wasmacs_eval_string,_wasmacs_garbage_collect,_wasmacs_last_result,_wasmacs_entrypoint_state,_wasmacs_command_state,_wasmacs_minibuffer_state,_wasmacs_os_lifecycle_phase,_wasmacs_os_root_state_snapshot,_wasmacs_os_gc_permission,_wasmacs_os_pending_command_state,_wasmacs_os_pin_backtrace_args,_wasmacs_os_release_backtrace_args,_wasmacs_os_push_gc_guard,_wasmacs_os_pop_gc_guard,_wasmacs_os_begin_command,_wasmacs_os_finish_command,_wasmacs_os_cancel_command,_wasmacs_input_text,_wasmacs_input_cancel"
