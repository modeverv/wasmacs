...
test -x "${repo_root}/scripts/probe-emacs-pdump-configure.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-temacs-build.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-loadup-gc-split.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-bindings-progress.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-bindings-defvar-variants.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-purecopy-trace.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-bindings-purecopy-markers.sh"
test -x "${repo_root}/scripts/probe-emacs-pdump-purecopy-enabled-trace.sh"

rg 'with-dumping=pdumper' "${repo_root}/scripts/probe-emacs-pdump-configure.sh" >/dev/null
rg 'with-pdumper=yes' "${repo_root}/scripts/probe-emacs-pdump-configure.sh" >/dev/null
...
rg 'wasm-side pdumper fingerprint workaround' "${repo_root}/scripts/probe-emacs-pdump-temacs-build.sh" >/dev/null
