...
doc="${repo_root}/doc/minibuffer-asyncify-entrypoint-plan.md"
build_script="${repo_root}/tools/scripts/build-emacs-browser-asyncify-spike.sh"
patch_script="${repo_root}/tools/scripts/patch-emacs-host-entrypoint-spike.sh"
host_library="${repo_root}/tools/scripts/wasmacs-asyncify-host-library.js"
advise_summary_script="${repo_root}/tools/scripts/summarize-asyncify-advise.mjs"
suspend_state_probe="${repo_root}/tools/scripts/probe-browser-asyncify-minibuffer-suspend-state.mjs"
input_injection_probe="${repo_root}/tools/scripts/probe-browser-asyncify-minibuffer-input-injection.mjs"
cancel_probe="${repo_root}/tools/scripts/probe-browser-asyncify-minibuffer-cancel.mjs"
artifact_dir="${repo_root}/build/artifacts/emacs-browser-asyncify-spike"
...
WASMACS_LOG_PATH="${boundary_log}" \
  node --stack-size=65500 "${repo_root}/tools/scripts/probe-browser-minibuffer-active-read-boundary.mjs" >/dev/null
