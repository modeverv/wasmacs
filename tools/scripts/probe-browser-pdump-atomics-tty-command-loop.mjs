...
if (!isMainThread) {
  ...
  const worker = new Worker(new URL(import.meta.url), {
    env: process.env,
    workerData: {
      pdmpPath:   `${repoRoot}/build/artifacts/emacs-browser-atomics-pdump/bootstrap-emacs.pdmp`,
      temacsDir:  `${repoRoot}/build/artifacts/emacs-browser-atomics-pdump`,
      temacsPath: `${repoRoot}/build/artifacts/emacs-browser-atomics-pdump/temacs`,
      logJsonlPath: logJ,
