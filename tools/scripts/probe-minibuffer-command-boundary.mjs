...
import { keyEventToBufferCommand, validateBufferCommand } from "../../src/wasm/src/input-protocol.js";

const repoRoot = new URL("../..", import.meta.url).pathname;
const workerSource = await readFile(`${repoRoot}/src/wasm/src/wasm-worker.js`, "utf8");
